...
public final class GetTopAnimeUseCase_Factory implements Factory<GetTopAnimeUseCase> {
  ...
  public GetTopAnimeUseCase_Factory(Provider<AnimeRepository> animeRepositoryProvider) {
  ...
  public static GetTopAnimeUseCase_Factory create(
      javax.inject.Provider<AnimeRepository> animeRepositoryProvider) {
    return new GetTopAnimeUseCase_Factory(Providers.asDaggerProvider(animeRepositoryProvider));
  }

  public static GetTopAnimeUseCase_Factory create(
      Provider<AnimeRepository> animeRepositoryProvider) {
    return new GetTopAnimeUseCase_Factory(animeRepositoryProvider);
  }

  public static GetTopAnimeUseCase newInstance(AnimeRepository animeRepository) {
    return new GetTopAnimeUseCase(animeRepository);
  }
}
